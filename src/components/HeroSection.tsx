      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        >
          <div className="relative">
            ...
            >
              <StarburstBadge text="NEW!" color="pink" className="w-20 h-20" />
            </motion.div>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Button as="a" href="#events" size="lg" color="yellow">
              Find an Event
            </Button>
            <Button as="a" href="#about" size="lg" color="white">
              Learn More
            </Button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative bg-white p-2 sm:p-3 rounded-xl sm:rounded-2xl border-4 border-black sticker-shadow z-10 transform transition-transform hover:rotate-0 duration-300">
            <div className="absolute -top-4 -right-4 sm:-top-5 sm:-right-5 lg:-top-6 lg:-right-6 z-20">
              <StarburstBadge text="FREE" color="yellow" className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24" />
            </div>
